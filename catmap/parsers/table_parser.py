...
class TableParser(ParserBase):
    ...
    def __init__(self, reaction_model=None, **kwargs):
        ...
        defaults = dict(
            ...
            required_headers=['species_name', 'surface_name', 'site_name', 'formation_energy', 'frequencies',
                              'reference'],
            ...
            if ads is None:
                ...
                if self.species_definitions[adsdef]['type'] not in ['gas']:
                    ...
                    if 'None' in infodict:
                        ...
                        raise ValueError('No formation energy found for ' +
                                         str(adsdef) + '. Check input file.')
    ...
    def parse_frequencies(self, **kwargs):
        ...
        def freq_handler(freqdict_entry, site, ads):
            ...
            for entry in freqdict_entry:
                masked = [entry[0] in self.frequency_surface_names,
                          entry[1] in self.species_definitions.get(
                ...
                # Surface matches but site might not...
                elif masked[0] and site not in self._gas_sites:
        ...
        for adsdef in all_ads + allfreqdict.keys():  # format all freqs
            ...
            if adsname in allfreqdict:
                frequency_dict[adsdef] = freq_handler(allfreqdict[adsname], site, adsname)
